...
namespace OrganicShopBackend.Migrations
{
    ...
    [Migration("20250205170702_AddUserOrderProductRelationships")]
    partial class AddUserOrderProductRelationships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrganicShopBackend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Freshio",
                            PasswordHash = "$2a$11$L7StjDGAnQwz6CdRg5th4.SqCCaXcMhHm3chAuTeBeozc5i0LhJx6",
