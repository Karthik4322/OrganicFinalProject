...
namespace OrganicShopBackend.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product
                {
                    ...
                    Images = new List<string> { "https://www.freepngimg.com/thumb/potato/7-potato-png-images-pictures-download-thumb.png" },
                ...
                new Product
                {
                    ...
                    Images = new List<string> { "https://www.freepngimg.com/thumb/onion/10-red-onion-png-image-thumb.png" },
                ...
                new Product
                {
                    ...
                    Images = new List<string> { "https://pngimg.com/uploads/beet/beet_PNG28.png" },
                ...
                new Product
                {
                    ...
                    Images = new List<string> { "https://www.freepngimg.com/thumb/categories/2985.png" },
                ...
                new Product
                {
                    ...
                    ReturnPolicy = "7 days return policy",
                    MinimumOrderQuantity = 5,
                    Images = new List<string> { "https://cdn.dummyjson.com/products/images/vegetables/Carrot/thumbnail.png" },
        ...
        new Product
        {
            ...
            Images = new List<string> { "https://cdn.dummyjson.com/products/images/groceries/Cooking%20Oil/1.png" },
        ...
        new Product
        {
            ...
            ReturnPolicy = "30 days return policy",
            MinimumOrderQuantity = 1,
            Images = new List<string> { "https://cdn.dummyjson.com/products/images/groceries/Rice/1.png" },
        ...
        new Product
        {
            ...
            ReturnPolicy = "30 days return policy",
            MinimumOrderQuantity = 1,
            Images = new List<string> { "https://cdn.dummyjson.com/products/images/groceries/Water/1.png" },
        ...
        new Product
        {
            ...
            ReturnPolicy = "30 days return policy",
            MinimumOrderQuantity = 1,
            Images = new List<string> { "https://cdn.dummyjson.com/products/images/groceries/Protein%20Powder/1.png" },
        ...
        new Product
        {
            ...
            Images = new List<string> { "https://cdn.dummyjson.com/products/images/groceries/Chicken%20Meat/2.png"
                    },
        ...
        new Product
        {
            ...
            ReturnPolicy = "30 days return policy",
            MinimumOrderQuantity = 1,
            Images = new List<string> { "https://images.immediate.co.uk/production/volatile/sites/30/2017/01/Bunch-of-bananas-67e91d5.jpg" },
